...
export function DashboardClient({ projects }: { projects: Project[] }) {
  ...
  return (
    <main className="flex-1 overflow-y-auto bg-stone-50">
      ...
      {/* ── 1. BANNER de boas-vindas ── só para quem não fez o tour ─── */}
      {showBanner && (
        <div className="bg-gradient-to-r from-trama-500 to-indigo-500 px-6 md:px-8 py-4">
          <div className="flex items-center justify-between gap-4 flex-wrap">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-sm font-semibold text-white">Bem-vindo ao TRAMA</p>
      ...
      <div className="p-6 md:p-8">
        ...
        <div className="flex items-center justify-between mb-6 gap-4 flex-wrap">
          ...
          {/* ── 2. BOTÃO DE TOUR fixo no cabeçalho ─────────────────── */}
          ...
          <>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4">
              ...
              <button onClick={() => setShowTemplate(true)}
                ...
                <span className="text-sm text-stone-400 group-hover:text-trama-500 transition">Novo projeto</span>
              </button>
            </div>
          </>
        )}

        {/* ── 3. TOUR em destaque no empty state ───────────────────── */}
        {projects.length === 0 && (
