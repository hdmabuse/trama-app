  ...
  return (
    <header className="h-14 bg-white border-b border-stone-200 flex items-center px-5 gap-4 shrink-0 z-30">
      <Link href="/dashboard" className="shrink-0">
        <span className="text-xl font-black text-trama-500 tracking-tight">
          trama
        </span>
      </Link>
      ...
      <div className="relative">
        ...
        {showMenu && (
          <div className="absolute right-0 top-10 bg-white border border-stone-200 rounded-lg shadow-lg py-1 w-48 z-50">
